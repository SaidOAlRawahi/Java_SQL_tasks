...
public class Employee {
	public static void readFromTable(Statement st) {
		String message = "How many Employees Do You Want To Print: ";
		System.out.print(message);
		int input = Main.getInput(message);
		try {
			String sql = "Select Top("+input+") * from Employees";
			
			ResultSet resultSet = st.executeQuery(sql);
			while (resultSet.next()) {
				System.out.println(resultSet.getString("id")); 
				System.out.println(resultSet.getString("employee_type_id"));
	...
	public static void getById(Statement st) {
		String message = "Which Employee Do You Want To Print (id): ";
		System.out.print(message);
		int input = Main.getInput(message);
		try {
			String sql = "Select * from Employees Where id = "+input+";";
	...
	public static void updateById(Statement st) {
		String message = "Which Employee Do You Want To Update (id): ";
		System.out.print(message);
		int input = Main.getInput(message);
		try {
			...
			sql = "Select * from Employees Where id = "+input+";";
	...
	public static void deleteById(Statement st) {
		String message = "Which Employee Do You Want To Delete (id): ";
		System.out.print(message);
		int input = Main.getInput(message);
		try {
	...
	public static void makeIsActiveFalseById(Statement st) {
		String message = "Which Employee Do You Want To Set Inactive (id): ";
		System.out.print(message);
		int input = Main.getInput(message);
		try {
			String sql = "UPDATE Employees\r\n"
	...
	public static void insertIntoTable(Statement st) {
		String message = "How Many Employees Do You want to Insert: ";
		System.out.print(message);
		int input = Main.getInput(message);
